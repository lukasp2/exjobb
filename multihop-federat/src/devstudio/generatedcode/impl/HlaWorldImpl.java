...
/*
 * Generated 2020-05-16 20:24:11 (+0200) by lukas using Pitch Developer Studio 5.0.3
 */

import devstudio.generatedcode.*;
import devstudio.generatedcode.exceptions.*;
import devstudio.generatedcode.impl.fed.FederateManager;
import devstudio.generatedcode.impl.fed.FederateInteractionManager;
import devstudio.generatedcode.impl.fed.ObjectManager;
import devstudio.generatedcode.impl.fed.SaveRestManager;
   ...
   public HlaWorldImpl(HlaSettings settings, boolean manualEvokeMode, HlaTimeStampFactory timeStampFactory) {
      ...
      if (HlaSettings.hasSettingsFile() || timeStampFactory == null) {
        ...
        // 2. If we did not pass in a timeStampFactory then use current settings
         String factoryName = _settings.getTimeStampFactoryName();
         if (factoryName != null) {
