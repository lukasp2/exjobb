 ...
 * <code>devstudio.generatedcode.settings</code> to a valid <i>Properties</i> file.
 * For example
 * <pre><code>
 * java -Ddevstudio.generatedcode.settings=MySettingsFile ...
 * </code></pre>
...
# RTI Profile to use (empty, A, B, C, D, E, F, G, H, I, J or K), default when empty is to use the
# first available
rtiDriverProfile = B
...
public class HlaSettings {
   ...
   protected String[] _additionalFomUrls = getSettings(ADDITIONAL_FOM_URLS_KEY, "NETN-Base_v1.0.2.xml;NETN-COM.xml;RPR-Base_v2.0.xml;RPR-Enumerations_v2.0.xml;RPR-Foundation_v2.0.xml;RPR-Switches_v2.0.xml;NETN-Physical_v1.1.1.2.xml;RPR-Physical_v2.0.xml;NETN-Base_v1.0.2.xml;NETN-COM.xml;NETN-Physical_v1.1.1.2.xml;PathFinder.xml;RPR-Base_v2.0.xml;RPR-Enumerations_v2.0.xml;RPR-Foundation_v2.0.xml;RPR-Physical_v2.0.xml;RPR-Switches_v2.0.xml");
   ...
   protected boolean _timeConstrained = getSetting(TIME_CONSTRAINED_KEY, false);
   protected boolean _timeRegulating = getSetting(TIME_REGULATING_KEY, false);
   ...
   private static final String KEY_PREFIX = "devstudio.generatedcode" + ".";
