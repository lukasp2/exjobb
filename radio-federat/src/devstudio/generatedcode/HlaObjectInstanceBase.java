...
public interface HlaObjectInstanceBase {
   ...
   public enum ObjectClassType {
      /** NETNGroundVehicle, instance of <code>HlaNETNGroundVehicle</code> (FOM name <code>HLAobjectRoot.BaseEntity.PhysicalEntity.Platform.GroundVehicle.NETN_GroundVehicle</code>) */
      NETNGROUND_VEHICLE(HlaNETNGroundVehicle.class);
