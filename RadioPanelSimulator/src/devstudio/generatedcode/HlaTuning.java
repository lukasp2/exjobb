...
public final class HlaTuning {
    ...
    * <code>devstudio.generatedcode.tuning.<b>request</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.request", Boolean.toString(false));
    * </code></pre>
    *
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>requestMinDelayMs</b></code>
    * to a valid <code>long</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.requestMinDelayMs", Long.toString(500));
    * </code></pre>
    *
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>requestMaxDelayMs</b></code>
    * to a valid <code>long</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.requestMaxDelayMs", Long.toString(1000));
    * </code></pre>
    *
    * Valid range is {@code [0 <= <i>min</i> <= <i>max</i> <= 3 600 000]} ({@code [0 ms ... 1 hr]}).
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>provide</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.provide", Boolean.toString(false));
    * </code></pre>
    *
    * The default value is <code>true</code>.
    *
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>conveyProducingFederate</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.conveyProducingFederate", Boolean.toString(false));
    * </code></pre>
    *
    * The default value is <code>true</code>.
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>autoAchieve</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.autoAchieve", Boolean.toString(false));
    * </code></pre>
    *
    * The default value is <code>true</code>.
    */
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>includeDataInDecodeException</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.includeDataInDecodeException", Boolean.toString(true));
    * </code></pre>
    *
    * The default value is <code>false</code>.
    *
    * @see devstudio.generatedcode.exceptions.HlaDecodeException
    */
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>verifyReceivedDataLength</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.verifyReceivedDataLength", Boolean.toString(true));
    * </code></pre>
    *
    * The default value is <code>false</code>.
    *
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>resignAction</b></code>
    * to a valid <code>int</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.resignAction", Integer.toString(0));
    * </code></pre>
    *
    * Valid values are:
    * <ul>
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>createFederationWithTimeRepresentation</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.createFederationWithTimeRepresentation", Boolean.toString(true));
    * </code></pre>
    *
    * The default value is <code>false</code>.
    */
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>alwaysUseLogicalTime</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.alwaysUseLogicalTime", Boolean.toString(true));
    * </code></pre>
    *
    * The default value is <code>false</code>.
    */
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>initialAdvanceWhenConstrained</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.initialAdvanceWhenConstrained", Boolean.toString(false));
    * </code></pre>
    *
    * The default value is <code>true</code>.
    */
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>initialAdvanceToEvenStepSize</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.initialAdvanceToEvenStepSize", Boolean.toString(false));
    * </code></pre>
    *
    * The default value is <code>true</code>.
    */
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>forceFrameTimesWhenEventBased</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.forceFrameTimesWhenEventBased", Boolean.toString(false));
    * </code></pre>
    *
    * The default value is <code>true</code>.
    */
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>enableAsynchronousDelivery</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.enableAsynchronousDelivery", Boolean.toString(false));
    * </code></pre>
    *
    * The default value is <code>true</code>.
    */
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>notificationQueueCapacity</b></code>
    * to a valid <code>int</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.notificationQueueCapacity", Integer.toString(10));
    * </code></pre>
    *
    * Valid range is {@code [1 <= <i>value</i> <= Integer.MAX_VALUE]}.
    * The default value is <code>200 000</code> entries.
    */
   public static final int NOTIFICATION_QUEUE_CAPACITY =
         inRange(1, getSetting("notificationQueueCapacity", 200000), Integer.MAX_VALUE);
    ...
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>advanceWaitsForNotifications</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.advanceWaitsForNotifications", Boolean.toString(false));
    * </code></pre>
    *
    * The default value is <code>true</code>.
    */
   ...
   /**
    * Time management will be enabled on connect. If flag is false, <code>HlaWorld.enableTimeManagement</code>
    * must be called to enable time management.
    * <p>
    * This value is changed by setting the System Property
    * <code>devstudio.generatedcode.tuning.<b>delayEnablingTimeManagement</b></code>
    * to a valid <code>boolean</code> value before this class is loaded.
    *
    * <pre><code>
    * System.setProperty("devstudio.generatedcode.tuning.enableTimeManagementOnConnect", Boolean.toString(false));
    * </code></pre>
    *
    * The default value is <code>true</code>.
    */
   ...
   private static final String KEY_PREFIX = "devstudio.generatedcode" + ".tuning.";
