...
public class HlaSettings {
   ...
   protected String _evolvedFomUrl = getSetting(EVOLVED_FOM_URL_KEY, getSetting(FOM_URL_KEY, "NETN-COM.xml"));
   protected String[] _additionalFomUrls = getSettings(ADDITIONAL_FOM_URLS_KEY, "NETN-Base_v1.0.2.xml;RPR-Base_v2.0.xml;RPR-Enumerations_v2.0.xml;RPR-Foundation_v2.0.xml;RPR-Switches_v2.0.xml;PathFinder.xml");
