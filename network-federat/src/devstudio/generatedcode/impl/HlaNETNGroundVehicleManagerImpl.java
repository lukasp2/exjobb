...
import devstudio.generatedcode.impl.encoders.SpatialVariantStructEncoder;
...
final class HlaNETNGroundVehicleManagerImpl extends AbstractObjectClassManager implements HlaNETNGroundVehicleManager {
   ...
   /* @GuardedBy("_encodersLock") */
   protected final SpatialVariantStructEncoder _spatialVariantStructEncoderEncoder = new SpatialVariantStructEncoder();
   /* @GuardedBy("_decodersLock") */
   protected final SpatialVariantStructEncoder _spatialVariantStructEncoderDecoder = new SpatialVariantStructEncoder();
